...
class NeuronSimulation:
    def __init__(self, tstop, dt=None, seed=123456789, abs_tol=None, rel_tol=None):
        ...
        self.randoms = []
        self.next_global_id = (
            0  # Used in Random123 classes for elements using random(), etc.
        )

        self.next_spiking_input_id = (
            0  # Used in Random123 classes for elements using random(), etc.
        )
        ...
        print(
            "Population population_null contains 1 instance(s) of component: Lavrentovich2008_Ca_Oscillations_0 of type: Lavrentovich2008_Ca_Oscillations"
        )
        ...
        for i in range(int(h.n_population_null)):
            ...
            h.population_null[i](
                0.5
            ).diam = 10.0  # diameter to use for section in Neuron
            h.population_null[i].push()
            h(
                " population_null[%i]  { m_Lavrentovich2008_Ca_Oscillations_0_population_null[%i] = new Lavrentovich2008_Ca_Oscillations_0(0.5) } "
                % (i, i)
            )

            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].vin = 0.05  # NRN unit is:
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].kout = 0.5  # NRN unit is:
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].vM3 = 40.0  # NRN unit is:
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].k_CaA = 0.15  # NRN unit is:
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].n = 2.02  # NRN unit is:
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].k_CaI = 0.15  # NRN unit is:
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].m = 2.2  # NRN unit is:
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].kip3 = 0.1  # NRN unit is:
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].vM2 = 15.0  # NRN unit is:
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].k2 = 0.1  # NRN unit is:
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
            ...
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].kdeg = 0.08  # NRN unit is:
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].tscale = 0.001  # NRN unit is: (kHz)
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].compartment = 1.0  # NRN unit is:
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].ER = 1.0  # NRN unit is:
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].init_X = 0.1  # NRN unit is:
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].init_Y = 1.5  # NRN unit is:
            h.m_Lavrentovich2008_Ca_Oscillations_0_population_null[
                i
            ].init_Z = 0.1  # NRN unit is:
            h.pop_section()
        ...
        h(
            " { v_os_X_outputFile1.record(&m_Lavrentovich2008_Ca_Oscillations_0_population_null[0].X) } "
        )
        ...
        h(
            " { v_os_Y_outputFile1.record(&m_Lavrentovich2008_Ca_Oscillations_0_population_null[0].Y) } "
        )
        if self.abs_tol is None or self.rel_tol is None:
        ...
        h(
            " { v_os_Z_outputFile1.record(&m_Lavrentovich2008_Ca_Oscillations_0_population_null[0].Z) } "
        )
        if self.abs_tol is None or self.rel_tol is None:
    ...
    def run(self):
        ...
        if self.abs_tol is not None and self.rel_tol is not None:
            print(
                "Running a simulation of %sms (cvode abs_tol = %sms, rel_tol = %sms; seed=%s)"
                % (h.tstop, self.abs_tol, self.rel_tol, self.seed)
            )
        else:
            print(
                "Running a simulation of %sms (dt = %sms; seed=%s)"
                % (h.tstop, h.dt, self.seed)
            )
        ...
        print(
            "Finished NEURON simulation in %f seconds (%f mins)..."
            % (self.sim_time, self.sim_time / 60.0)
        )
    ...
    def save_results(self):
        ...
        ]  # Convert to Python list for speed...
        ...
        py_v_os_X_outputFile1 = [
            float(x) for x in h.v_os_X_outputFile1.to_python()
        ]  # Convert to Python list for speed, variable has dim: none
        py_v_os_Y_outputFile1 = [
            float(x) for x in h.v_os_Y_outputFile1.to_python()
        ]  # Convert to Python list for speed, variable has dim: none
        py_v_os_Z_outputFile1 = [
            float(x) for x in h.v_os_Z_outputFile1.to_python()
        ]  # Convert to Python list for speed, variable has dim: none
        ...
        for i in range(num_points):
            f_outputFile1_f2.write(
                "%e\t%e\t%e\t%e\t\n"
                % (
                    py_v_time[i],
                    py_v_os_X_outputFile1[i],
                    py_v_os_Y_outputFile1[i],
                    py_v_os_Z_outputFile1[i],
                )
            )
...
if __name__ == "__main__":
    ns = NeuronSimulation(
        tstop=1000000.0, dt=10.0, seed=123456789, abs_tol=None, rel_tol=None
    )
