...
def main():
    ...
    for model_id in model_ids:
        ...
        try:
            ...
            results_remote = {e: {"log_yml": {"status": "HTTPError", "error_message": str(e), "exception_type": type(e).__name__}} for e in engine_keys}
        ...
        for e in engine_keys:
            ...
            if results_remote_processed["error_message"] == "":
                mtab[remote_outcome_key] = results_remote_processed['status']
            else:
