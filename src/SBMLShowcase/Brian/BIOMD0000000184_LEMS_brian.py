...
print(
    "Running simulation for %s (dt = %s, #steps = %s)"
    % (duration, defaultclock.dt, steps)
)
...
all_outputFile1 = np.array(
    [
        record_outputFile1__os_X.times,
        record_outputFile1__os_X[0],
        record_outputFile1__os_Y[0],
        record_outputFile1__os_Z[0],
    ]
)
...
if show_gui:
    ...
    plot_X__S.plot(
        trace_disp1__X__S.times / second,
        trace_disp1__X__S[0],
        color="#000000",
        label="X__S",
    )
    ...
    plot_Y__S.plot(
        trace_disp1__Y__S.times / second,
        trace_disp1__Y__S[0],
        color="#ff0000",
        label="Y__S",
    )
    ...
    plot_Z__S.plot(
        trace_disp1__Z__S.times / second,
        trace_disp1__Z__S[0],
        color="#00ff00",
        label="Z__S",
    )
